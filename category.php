...
<div class="py-5 px-3 mb-3 bg-50 position-relative wrapper-banner-tour-page">
    ...
    <h1 class="py-5 text-center fs-1 fw-bold"><?php single_cat_title(); ?></h1>
</div>
<!--  Fin Banner Category -->
...
<article class="py-default position-relative">
    <div class="container">
        <div class="article-blog">
            ...
            <?php 
                $categoria = get_queried_object(); 
                echo category_description($categoria->term_id);
            ?>
        </div>
    </div>
</article>
        ...
        <div class="row gy-3 flex-md-row-reverse">
            ...
            <div class="col-md-12 col-lg-8">
                <div class="position-relative">
                    <h2 class="fw-bold h4 text-uppercase mb-4 text-primary"><?php single_cat_title(); ?></h2>
                    <!--  tours -->
                    <div class="row gy-3">
                        <?php
                            $categoria = get_queried_object();
