...
<article class="py-default position-relative">
    <div class="container">
        <div class="text-center article-blog w-lg-75 mx-auto">
            <!-- content -->
            <h2><?php echo PearTheme::lang('Choose the Ulitmate Tour for '.date('Y'),'Elige el tour definitivo para '.date('Y'),'选择'.date('Y').'年终极之旅','Escolha a excursão definitiva para '.date('Y'))?></h2>
            <p><?php echo PearTheme::lang('Our Tours offer an immersive adventure to one of the world’s most renowned ancient wonders. With a range of options tailored to different interests and fitness levels, our tours provide everything from challenging treks on the Inca Trail to relaxing guided visits with breathtaking views. Experience the majestic ruins, delve into the rich history and culture of the Inca civilization, and enjoy exceptional service and expertise. Join us for a journey that combines exploration, education, and awe-inspiring scenery at Machu Picchu.','Nuestros tours ofrecen una aventura inmersiva a una de las maravillas antiguas más famosas del mundo. Con una variedad de opciones adaptadas a diferentes intereses y niveles de aptitud física, nuestros tours ofrecen desde desafiantes caminatas por el Camino Inca hasta relajantes visitas guiadas con vistas impresionantes. Experimente las majestuosas ruinas, adéntrese en la rica historia y cultura de la civilización inca y disfrute de un servicio y una experiencia excepcionales. Acompáñenos en un viaje que combina exploración, educación y paisajes impresionantes en Machu Picchu.','我们的旅行团将带您深入探索世界最负盛名的古代奇迹之一。针对不同兴趣与体能水平，我们提供多样化的行程选择——从印加古道上的挑战性徒步，到饱览壮丽景色的轻松导览之旅。您将亲历雄伟的遗址群，深入了解印加文明的悠久历史与文化底蕴，并享受卓越的服务与专业指导。加入我们，在马丘比丘开启融合探索之旅、文化启迪与震撼景致的非凡旅程。','Nossos passeios oferecem uma aventura imersiva a uma das maravilhas antigas mais renomadas do mundo. Com uma variedade de opções adaptadas a diferentes interesses e níveis de condicionamento físico, nossos passeios oferecem de tudo, desde caminhadas desafiadoras na Trilha Inca até visitas guiadas relaxantes com vistas deslumbrantes. Conheça as ruínas majestosas, mergulhe na rica história e cultura da civilização Inca e desfrute de um serviço e experiência excepcionais. Junte-se a nós em uma jornada que combina exploração, educação e paisagens inspiradoras em Machu Picchu.')?></p>
        </div>
    </div>
</article>
