...
<!--  Banner Category -->
<div class="py-5 px-3 bg-50 position-relative wrapper-banner-tour-page">
...
<div class="py-default position-relative">
    <div class="container">
        <h2 class="text-center mb-5 fw-bold-600 text-primary"><?php echo PearTheme::lang('What We Offer','Lo que ofrecemos','我们的服务','O que nós oferecemos')?></h2>
        <div class="textBlogLeft">
            <figure><?php the_post_thumbnail('full-size',array('class'=>'')) ?></figure>
            <h3><?php echo PearTheme::lang('Local Expertise','Experiencia local','本地专业知识','Experiência local')?></h3>
            <p>
