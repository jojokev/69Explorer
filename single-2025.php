...
<main class="main-Tour-2025">
    ...
    <!-- Navigation Tour -->
    <!-- Navigation Top Tour -->
    <section class="navigation-tour py-2 bg-white" id="navigation-tour">
        <div class="container-xl">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit"
                    ...
                    form="fromInquire"><?php echo PearTheme::lang('Send Form', 'Enviar formulario', '发送表单', 'Enviar formulário') ?></button>
            </div>
        </div>
    </div>
</div>
